...
namespace mz.erp.ui.forms
{
	...
	public class FrmSeleccionEstadoDeItems : System.Windows.Forms.Form, ITaskForm
	{
        ...
        private Infragistics.Win.UltraWinEditors.UltraDateTimeEditor udtFechaEntrega;
		...
		private void InitEventHandlers()
		{
            ...
            this.udtFechaEntrega.ValueChanged += new EventHandler(udtFechaEntrega_ValueChanged);
		}

        void udtFechaEntrega_ValueChanged(object sender, EventArgs e)
        {
            System.Console.WriteLine(this.udtFechaEntrega.Value);
            _uiController.AsignarFechaAItems((DateTime)this.udtFechaEntrega.Value);
        }
